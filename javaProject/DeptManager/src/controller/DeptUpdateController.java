...
//			전체 리스트 출력
		System.out.println("부서 정보 수정를 시작합니다.");
		System.out.println();
...
//		Dept => 새로 입력한 데이터를 가지는 Dept
	...
	public static void main(String[] args) {
		DeptUpdateController updateController = new DeptUpdateController();

		Dept dept = updateController.inputUpdateDept();
		System.out.println(dept);
	}
}
