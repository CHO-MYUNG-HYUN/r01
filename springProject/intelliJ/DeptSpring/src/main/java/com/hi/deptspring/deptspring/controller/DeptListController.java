...
public class DeptListController {
    ...
    public void getListPage(
        ...
        deptSearchOption.setKeyword(
                deptSearchOption.getKeyword() != null &&
                deptSearchOption.getKeyword().trim().length() > 0
                        ? deptSearchOption.getKeyword() : null );
        deptSearchOption.setSearchType(
                deptSearchOption.getSearchType() != null &&
                deptSearchOption.getSearchType().trim().length() > 0
                        ? deptSearchOption.getSearchType() : null);
