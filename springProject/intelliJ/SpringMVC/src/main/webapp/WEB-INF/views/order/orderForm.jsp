...
<form method="post">
  ...
  <h3>상품 1</h3>
  ID - <input type="text" name="orderItems[0].itemId"> <br><!--setItemId(사용자 입력파마리터 데이터)-->
  개수 - <input type="number" name="orderItems[0].number"> <br>
  주의 - <input type="text" name="orderItems[0].remark"> <br>

  <h3>상품 1</h3>
  ID - <input type="text" name="orderItems[1].itemId"> <br><!--setItemId(사용자 입력파마리터 데이터)-->
  개수 - <input type="number" name="orderItems[1].number"> <br>
  주의 - <input type="text" name="orderItems[1].remark"> <br>

  <h3>상품 1</h3>
  ID - <input type="text" name="orderItems[2].itemId"> <br><!--setItemId(사용자 입력파마리터 데이터)-->
